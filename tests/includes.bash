...
export GIT_AUTOREBASE_VERSION="v0.7.2"
export GIT_FPC_VERSION="v0.6.3"
export GIT_RANK_VERSION="v0.2.1"
export GIT_OPUSH_VERSION="v0.6.2"
export GIT_WORKLOG_VERSION="v0.1.1"
export GIT_WALKTREE_VERSION="v0.1.3"
export GIT_STALE_BRANCHES_VERSION="v0.5.1"
export STRIP_TRAILING_WHITESPACE_VERSION="v0.6.1"
